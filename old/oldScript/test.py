...
def main():
    ...
    data1 = pd.read_json('/home/fabrice/PycharmProjects/GANMovie/jsonStore/0.json', lines=True)
    data2 = pd.read_json('/home/fabrice/PycharmProjects/GANMovie/jsonStore/1.json', lines=True)
    ...
    if data1['truncation'].values != data2['truncation'].values:
        ...
        for key in keysList:
            ...
            gaanBreederCli.main(arguments, 0)
